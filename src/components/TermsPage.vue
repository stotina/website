<template>
  <div style="margin:auto; width:90%; max-width:600px;">
    <div class="terms">
      <h2><strong>Terms and Conditions</strong></h2>

      <p>Welcome to Stotina!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Stotina.com's Website, located at https://stotina.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Stotina if you do not agree to take
      ...
      <p>
        Unless otherwise stated, Stotina.com and/or its licensors own the
        intellectual property rights for all material on Stotina. All
        intellectual property rights are reserved. You may access this from
        Stotina for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Stotina</li>
        <li>Sell, rent or sub-license material from Stotina</li>
        <li>Reproduce, duplicate or copy material from Stotina</li>
        <li>Redistribute content from Stotina</li>
      </ul>
      ...
      <p>
        ...
        Stotina.com does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Stotina.com,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Stotina.com shall not be
      ...
      <p>
        Stotina.com reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Stotina.com a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Stotina.com; and (d) the link
      ...
      <p>
        ...
        e-mail to Stotina.com. Please include your name, your organization name,
      ...
      <p>
        No use of Stotina.com's logo or other artwork will be allowed for
