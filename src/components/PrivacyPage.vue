<template>
  <div style="margin:auto; width:90%; max-width:600px;">
    <div class="privacy">
      <h1>Privacy Policy for Stotina.com</h1>

      <p>
        At Stotina, accessible from https://stotina.com/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Stotina
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Stotina. This policy is not applicable to any
      ...
      <p>
        Stotina follows a standard procedure of using log files. These files log
      ...
      <P
        ...
        advertising partners of Stotina.</P
      >

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Stotina, which are sent directly
      ...
      <p>
        Note that Stotina has no access to or control over these cookies that
      ...
      <p>
        Stotina's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Stotina does not knowingly collect any Personal Identifiable Information
